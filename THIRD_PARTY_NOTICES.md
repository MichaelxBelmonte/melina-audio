...
Melina v0.13 bundles the following third-party runtime and model files.
...
- Status in Melina: optional experimental VAD for internal evaluation; review the additional terms before external or commercial distribution.
...
- Desktop UL-UNAS uses the official ONNX Runtime 1.27.0 C headers and the native runtime distributed inside the matching sherpa-onnx JVM platform JAR.
