...
without DeepFilterNet3. Official CI artifacts include libDF on every desktop target. The build uses
a documented, source-vendored tract-linalg patch for optimized Windows ARM64 assembly.
